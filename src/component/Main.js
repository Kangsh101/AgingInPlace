          ...
          {selectedSection === 'whatIsDementia' && (
            <div className='sul2'>
              ...
              <p className='sul1'>
                ...
                65세에서 74세는 3% 내외이나, 85세 이상은 45%가 치매로 추정됩니다. 알츠하이머병이 가장 많아서 47~61%, 혈관성 치매가 13~31%, 그 외 루이체 치매가 세 번째로 많을 것으로 보고되고 있습니다.</span>
              </p>
            </div>
          )}
          ...
          {selectedSection === 'treatments' && (
            <div className='sul2'>
              ...
              <p className='sul1'>
                <span className='sul11'>65세 이상 노인의 약 5~8%가 치매로 추정되고 있으며,</span> 
                <span className='sul111'>연령이 증가할 수록 급격히 증가해
                65세에서 74세는 3% 내외이나, 85세 이상은 45%가 치매로 추정됩니다. dasd알츠하이머병이 가장 많아서 47~61%, 혈관성 치매가 13~31%, 그 외 루이체 치매가 세 번째로 많을 것으로 보고되고 있습니다.</span>
              </p>
            </div>
          )}
