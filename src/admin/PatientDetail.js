                ...
                {diagnoses.map((diagnosis) => (
                  <div key={diagnosis.id} className="diagnosis-item">
                    <input
                      ...
                      placeholder="질환명 입력"
                      onChange={(e) => setDiagnoses(diagnoses.map(d => d.id === diagnosis.id ? { ...d, name: e.target.value } : d))}
                    />
                ...
                {medications.map((medication) => (
                  <div key={medication.id} className="medication-item">
                    <input
                      ...
                      placeholder="약명"
                      onChange={(e) => setMedications(medications.map(m => m.id === medication.id ? { ...m, name: e.target.value } : m))}
                    />
                    <input
                      type="text"
                      id='dosage'
                      ...
                      placeholder="용량"
                      onChange={(e) => setMedications(medications.map(m => m.id === medication.id ? { ...m, dosage: e.target.value } : m))}
                    />
                    <input
                      type="text"
                      id='frequency'
                      ...
                      placeholder="복용 횟수"
                      onChange={(e) => setMedications(medications.map(m => m.id === medication.id ? { ...m, frequency: e.target.value } : m))}
                    />
